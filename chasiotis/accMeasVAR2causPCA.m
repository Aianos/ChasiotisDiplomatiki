%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This  script  calculates  accuracy measures of VAR systems order 2 %
% for varius lengths and sizes (N) of timeseries models of causality %
% index of pcaCGCI and saves them in .xlsx files                     %                                        
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for Length = [200 400 800 1600]  
        ...
        for percMin = [0.92 0.94 0.96 0.98]
            ...
            for i=1:nMC
                ...
                [xM,A] = VAR_Struct.VAR2SFNGStructure(Length,N); 
                %[xM,A] = VAR_Struct.VAR2RingStructure(Length,N); 
                %[xM,A] = VAR_Struct.VARpRandom(Length,N,m);


                %Granger Causality index 
                [CGCIM2,pCGCIM2] = Caus_Func.pcaCGCinall(xM,m,percMin,1);
                ...
                I = diag(ones(N,1));
                adjM2 = Calc_Func.adjFDRmatrix(pCGCIM2,alpha);
                ...
                [perfomancestatsV2] = Calc_Func.AccuracyMeasuresAdjacency(trueVal,estimVal2);
