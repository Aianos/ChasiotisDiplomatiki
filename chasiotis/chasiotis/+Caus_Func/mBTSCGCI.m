...
RCGCIV = zeros(K,1);
pRCGCIV = NaN(K,1);
[indexV,maxorder]=Caus_Func.mBTS(xM,responseindex,pmax);
if maxorder>0
    ...
    MSEunrestricted=Caus_Func.DRfitmse(xM,responseindex,maxorder*ones(1,K),...
        unrestrictedindexV);
    ...
    for iK=drivingV
        ...
        MSErestricted=Caus_Func.DRfitmse(xM,responseindex,maxorder*ones(1,K),...
            restrictedindexV);
